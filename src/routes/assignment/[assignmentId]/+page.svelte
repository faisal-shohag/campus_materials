...
<div class={flex}>
  <div class="container" bind:this={container}>
    <form>
      ...
      <textarea
        ...
        bind:value={info.assignment_on}
      />
      <div class="input-group">
        <input
          type="text"
          placeholder="Course Code"
          bind:value={info.course_code}
        />
      </div>
      <div class="input-group">
        <input
      ...
      <div class="input-group">
        <input
          ...
          bind:value={info.teacher_name}
        />
      </div>
      <div class="input-group">
        <input
          type="text"
          placeholder="Teacher's Department"
          bind:value={info.teacher_dept}
        />
      </div>
      <div class="col-half">
        <div class="input-group">
      ...
      <div class="col-half">
        ...
        <div class="input-group">
          <input
            ...
            min="2023-03-01"
            max="2080-12-31"
            bind:value={info.submission_date}
            required
          />
  ...
  <svelte:component
    this={models[assignmentId].model}
    bind:this={bindFunction}
    myinfo={{ ...info, submission_date: dateMe(info.submission_date) }}
  />
</div>
